...
include-in-header:
  text: |
    ...
    <style>
      ...
      .page-wrap { max-width: 980px; margin: 0 auto; padding: 5rem 2rem 7rem; }
      .page-label {
      ...
      .two-col { display: grid; grid-template-columns: 1fr 1.6fr; gap: 5rem; align-items: start; }
      @media (max-width: 700px) { .two-col { grid-template-columns: 1fr; gap: 3rem; } }
      .bio-aside {}
      ...
      .bio-main h2 {
        ...
        color: #f0ebe3; margin: 2.5rem 0 0.75rem; border-bottom: 1px solid rgba(232,224,213,0.08);
        padding-bottom: 0.5rem;
      }
      .bio-main h2:first-child { margin-top: 0; }
      .bio-main p { color: #a09890; line-height: 1.82; font-size: 1rem; margin-bottom: 1rem; }
      ...
      .timeline li {
        ...
        position: relative; color: #a09890; font-size: 0.94rem; line-height: 1.65;
      }
      .timeline li::before {
        content: '';
        ...
        background: #e63946;
        border-radius: 50%;
        position: absolute; left: -4px; top: 1.35rem;
      }
      .timeline .year {
        font-family: 'IBM Plex Mono', monospace; font-size: 0.68rem;
      ...
      .philosophy-quote p {
        ...
        font-size: 1.15rem; color: #d4ccc4; line-height: 1.65; margin: 0;
      }
    </style>
---
...
<nav class="nav-strip">
  ...
  <a href="/about.html" class="nav-lang">🇫🇮 Suomeksi</a>
</nav>
  ...
  <div class="two-col">
    ...
    <main class="bio-main">
      ...
      <p>
        ...
        Before going independent, I worked as a statistician at the Finnish Institute for Health and Welfare (THL), 
        as a data scientist at OP Group, and as a statistical expert at Sosiaalitaito Oy. 
      ...
      <p>
        Current active projects include distributional analysis of Finnish legislation 
        via the Semantic Finlex linked open data service, and an 11-part Quarto/R series 
        on Finnish labour market dynamics.
      </p>
      ...
      <ul class="timeline">
        ...
        <li>
          ...
          Statistician / Statistical Researcher, THL (Finnish Institute for Health and Welfare). 
          National health and welfare statistics, ~5 peer-reviewed publications.
        </li>
        <li>
          <span class="year">2014 – 2016</span>
          Statistical Expert, Sosiaalitaito Oy. Municipal social welfare statistics, 
          Western and Central Uusimaa.
        </li>
        <li>
          <span class="year">2009 – 2014</span>
          FM, Mathematics — University of Eastern Finland. 
          Minor subjects: computer science, statistics, economics. 
          Substitute teacher (mathematics, physics, chemistry) during studies.
        </li>
      </ul>
