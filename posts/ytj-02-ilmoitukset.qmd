...
**merkintälaji** (esim. `HAL` = hallitus, `KOTI` = kotipaikka/osoite,
`NIMA`/`NIML` = nimiasiat, `TILTAR` = tilintarkastaja, `PERUS` =
perustaminen). Nämä koodit ovat se sanasto, jolla yrityksen elämää voi
lukea.
