  ...
  text: |
    ...
    <style>
      ...
      .trust-strip {
        ...
        font-family: 'IBM Plex Mono', monospace !important; font-size: 0.68rem;
        letter-spacing: 0.03em; color: #857e76 !important;
      }
      ...
      .cta-hint {
        ...
        letter-spacing: 0.02em; color: #6b6560 !important; margin-top: 1rem;
        line-height: 1.65; max-width: 32rem;
      }
      .scarcity-note {
        font-family: 'IBM Plex Mono', monospace !important; font-size: 0.66rem;
        letter-spacing: 0.03em; color: #f4a261 !important; margin: 1.4rem 0 0;
      ...
      .tier-badge {
        ...
        color: #2a9d8f !important; border: 1px solid rgba(42,157,143,0.35);
        padding: 0.22rem 0.5rem; margin-bottom: 0.9rem;
      }
      .tier.featured .tier-badge { color: #f4a261 !important; border-color: rgba(244,162,97,0.4); }
      .promise-band {
        display: grid; grid-template-columns: 1fr; gap: 1px;
        background: rgba(232,224,213,0.06); border: 1px solid rgba(42,157,143,0.18);
        margin-top: 1.5rem;
      }
      @media (min-width: 700px) { .promise-band { grid-template-columns: repeat(3, 1fr); } }
      .promise-card { background: #0f1a24 !important; padding: 1.9rem 1.5rem; }
      .promise-card .p-label {
        font-family: 'IBM Plex Mono', monospace !important; font-size: 0.6rem;
        letter-spacing: 0.16em; text-transform: uppercase; color: #2a9d8f !important;
        margin-bottom: 0.7rem; display: block;
      }
      .promise-card h4 { font-family: 'Playfair Display', serif !important; font-size: 1.08rem !important; color: #f0ebe3 !important; margin-bottom: 0.5rem; }
      .promise-card p { font-size: 0.85rem; color: #a09890 !important; line-height: 1.65; margin: 0; }
      .gift-box {
        margin-top: 1.5rem; padding: 2.2rem 2rem;
        background: linear-gradient(135deg, rgba(244,162,97,0.09) 0%, rgba(230,57,70,0.06) 100%) !important;
      ...
      .gift-box .gift-tag {
        font-family: 'IBM Plex Mono', monospace !important; font-size: 0.6rem;
        letter-spacing: 0.16em; text-transform: uppercase; color: #f4a261 !important;
        margin-bottom: 0.7rem; display: block;
      }
      .gift-box h3 { font-family: 'Playfair Display', serif !important; font-size: 1.35rem !important; color: #f0ebe3 !important; margin-bottom: 0.6rem; }
      .gift-box p { color: #a09890 !important; font-size: 0.9rem; line-height: 1.72; margin: 0; }
